...
for step, (xi, yi) in zip(range(args.n_epochs), dataloader(
    ...
    if (step + 1) % 25 == 0 or (step + 1) == args.n_epochs:
        ...
        print(f"{args.k}, {train_loss}, {test_loss}, {AIC(train_loss, x_train.shape[0], supports, args.layer_sizes[1])},{args.err_dist}, {args.n_train_obs}, {args.round}, {step + 1}, {end-start}")